...
const handleRegister = async (req: Request, res: Response) => {
  if (req.method === "POST") {
    const data = req.body;
    console.log("Received data:", data); // Agrega un console.log para rastrear los datos recibidos
    ...
    try {
      ...
      console.log("Email sent successfully."); // Agrega un console.log para rastrear el envío exitoso
